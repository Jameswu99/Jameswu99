...
words = ['alberta', 'british columbia', 'manitoba','new brunswick', 'newfoundland and labrdor', 'northwest territories',
         'nova scotia', 'nunavut', 'ontario','prince edward island', 'quebec', 'saskatchewan','yukon', 'rhode island',
         'delaware','connecticut', 'hawaii', 'new jersey','massachusetts', 'new hampshire', 'vermont','maryland',
         'west virginia', 'south carolina','maine', 'virginia', 'kentucky', 'ohio', 'tennessee', 'louisiana',
         'pennsylvania', 'mississippi', 'new york','north carolina', 'albama', 'arkansas','florida', 'wisconsin',
         'illinois','iowa', 'michigan', 'georgia','washington', 'oklahoma', 'missouri', 'north dakota', 'south dakota',
         'nebraska', 'minnesota', 'kansas', 'utah', 'idaho', 'oregon', 'wyoming', 'colorado', 'nevada', 'arizona',
         'new mexico', 'montana', 'california', 'texas', 'alaska', 'nord-norge', 'midt-norge', 'vestlandet',
