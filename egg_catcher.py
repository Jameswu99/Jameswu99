...
score = 0
score_txt = c.create_text(10, 10, anchor='nw', font=game_font, fill='darkblue', text='Score: ' + str(score))

difficulty = int(input('Choose difficulty (type 1, 2, 3 or 4):\n 1 Easier Than Easy\n 2 Easy\n 3 Normal\n 4 Hard\n'))
if difficulty == 1:
    lives_remaining = 12
elif difficulty == 2:
    lives_remaining = 9
...
def egg_dropped(egg):
    ...
    if lives_remaining == 0:
        messagebox.showinfo('Game Over', 'Final Score: ' + str(lives_remaining))
        root.destroy()
