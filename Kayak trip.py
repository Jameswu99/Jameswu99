...
fruits = ['durian', 'jackfruit', 'white pitaya', 'dragon fruit', 'cherimoya', 'kiwano', 'horned melon', 'korean melon',
          'passion fruit', 'feijoa', 'pineapple guava', 'tamarillo', 'tree tomato', 'loquat', 'sour plum', 'longan',
          'physalis', 'golden berries', 'mulberries', 'jujube','date', 'lime']
adjectives = ['overwrought', 'helpless', 'freezing', 'great', 'flimsy', 'hurt', 'reminiscent', 'difficult',
              'satisfying', 'lethal']
adverbs = ['weekly', 'generally', 'tensely', 'therefore', 'usually', 'roughly',
           'frankly', 'greatly', 'ultimately', 'briefly', 'finally', 'queasily']
feeling = ['hopeful', 'interested', 'worried', 'confident', 'heartbroken', 'excited', 'confused', 'overwhelmed',
           'surprised', 'happy', 'strong', 'hesitant', 'loved', 'playful', 'rejected', 'stressed']
...
place_name = ['city of Oran', 'city of Chaozhou', 'city of Quito', 'city of Isfahan', 'city of Qom', 'Zzyzx Raod',
              'city of Ptuj', 'city of Qeqertarsuatsiaat', 'village of Å', 'D river']
